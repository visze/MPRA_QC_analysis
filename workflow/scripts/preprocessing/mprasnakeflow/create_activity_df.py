...
def create_activity_df(bcalm_statistics_file, reporter_experiment_barcode_file, output_file, fdr):
    ...
    bcalm_statistics.rename(columns={"oligo": "cCRE", "logFC": "RNA_DNA_ratio_log_rep_comb", "t": "activity_statistic", "P.Value":"activity_pval", "adj.P.Val": "activity_fdr"}, inplace=True)
    ...
    bcalm_statistics[["cCRE", "DNA_rep_comb", "RNA_rep_comb", "activity_status", "RNA_DNA_ratio_log_rep_comb", "activity_statistic", "activity_pval", "activity_fdr"]].to_csv(output_file, index=False)
